...
<div class="row">
        <div class="col-md-10">
            ...
            <a class="btn btn-outline-primary btn-sm" style=font-size: .900rem; href="/items/edit/{{$item->id}}">編集</a>
            </td>
            ...
            <input class="delete-action btn btn-outline-danger btn-sm" style=font-size: .900rem; type="submit" value="削除"> 
            </form> 
            </td>
            </tr>
            @endif
